  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved lead as @lead" do
        ...
        post :create, {:lead => { "email_address" => "invalid value" }}, valid_session
        assigns(:lead).should be_a_new(Lead)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lead" do
        ...
        Lead.any_instance.should_receive(:update_attributes).with({ "email_address" => "MyString" })
        put :update, {:id => lead.to_param, :lead => { "email_address" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the lead as @lead" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Lead.any_instance.stub(:save).and_return(false)
        put :update, {:id => lead.to_param, :lead => { "email_address" => "invalid value" }}, valid_session
        assigns(:lead).should eq(lead)
      end
